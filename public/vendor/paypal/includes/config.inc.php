...
$paypal[business]=$cfg['paypal']['account'];
$paypal[site_url]="http://".$_SERVER['SERVER_NAME'];
$paypal[image_url]="/assets/logo_mini.jpg";
$paypal[success_url]="/vendor/paypal/success.php";
//$paypal[success_url]="php_paypal/ipn/ipn.php";
$paypal[cancel_url]="/vendor/paypal/error.php";
//$paypal[notify_url]="/vendor/paypal/ipn/ipn.php";
